...
file_path="./data/processed_data/dis/"
figure_path='./figure/'

tag_name=['R6P','U8','9640']
figure_letter=['a','b','c']
color_array=['#4586BD','#55AC3D']
label_name=['ITP','Raw-RSSI']
line_type=['-','--']
...
for tind in range(len(tag_name)):
    ...
    plt.xlabel('Error(m)',fontsize=26)
    ...
    plt.savefig(f'{figure_path}figure18_{figure_letter[tind]}.svg', format='svg')
    plt.show()