...
| **Figure 14** | `src/Fig14_9640.py` <br> `src/Fig14_R6P.py` <br>`src/Fig14_U8.py` | `rssi_cor_error.txt` | Python |
| **Figure 15** | `src/Fig15_9640.py` <br> `src/Fig15_R6P.py` <br>`src/Fig15_U8.py` | `rssi_cor_dis_error.txt` | Python |
...
├── Fig14_9640.py       # Script analyzing the impact of transmit power on correction error (tag 9640, Figure 14)
├── Fig14_R6P.py        # Script analyzing the impact of transmit power on correction error (tag R6P, Figure 14)
├── Fig14_U8.py         # Script analyzing the impact of transmit power on correction error (tag U8, Figure 14)
├── Fig15_9640.py       # Script analyzing the impact of distance on correction error (tag 9640, Figure 15)
├── Fig15_R6P.py        # Script analyzing the impact of distance on correction error (tag R6P, Figure 15)
├── Fig15_U8.py         # Script analyzing the impact of distance on correction error (tag U8, Figure 15)
...
python ./src/Fig14_9640.py
python ./src/Fig14_R6P.py
python ./src/Fig14_U8.py
python ./src/Fig15_9640.py
python ./src/Fig15_R6P.py
python ./src/Fig15_U8.py
```
...
#### 1. Tag RSSI Data (`R420_xxxx.txt`)
Files such as `R420_9640.txt`, `R420_R6P.txt`, and `R420_U8.txt` contain **RSSI readings** collected from the reader R420 and different tags.
...
- **Code:** Three separate scripts:
  - `src/Fig14_9640.py` (for tag 9640)
  - `src/Fig14_R6P.py` (for tag R6P)
  - `src/Fig14_U8.py` (for tag U8)
  - **Each saves its own figure to `./figure/`**
...
- **Code:** Three separate scripts:
  ...
  - `src/Fig15_R6P.py`
  - `src/Fig15_U8.py`
  - **Each saves its figure to `./figure/`**
