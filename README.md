...
Before executing data preprocessing, it is necessary to ensure that the output path of the preprocessing program exists, and if necessary, create the corresponding folder first:

```bash
mkdir -p ./data/processed_data/itp
mkdir -p ./data/processed_data/3d
mkdir -p ./data/processed_data/dis
mkdir -p ./data/processed_data/csv
```
